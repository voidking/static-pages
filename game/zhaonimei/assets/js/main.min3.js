...
shareData = {
    imgUrl: "http://njityx.jd-app.com/zhaonimei/zhaonimei.jpg",
    timeLineLink: "http://njityx.jd-app.com/zhaonimei/",
...
function(a) {
    ...
    f = {
        init: function() {
            this.initEvent(),
            this.loading(),
            /android/i.test(c) ? (b.banner.attr("href", "http://mp.weixin.qq.com/s?__biz=MjM5NjM2NTE5MQ==&mid=201154871&idx=1&sn=a89fe072f4c2bd5f32afb7a541049348#rd").data("type", "android").find("img").attr("src", "assets/img/banner.android.jpg"), b.banner.show()) : /iphone|ipad|ipod/i.test(c) && (b.banner.attr("href", "http://mp.weixin.qq.com/s?__biz=MjM5NjM2NTE5MQ==&mid=201154871&idx=1&sn=a89fe072f4c2bd5f32afb7a541049348#rd").data("type", "ios").find("img").attr("src", "assets/img/banner.ios.jpg"), b.banner.show())
        },
        loading: function() {
            function a() {
                d++,
